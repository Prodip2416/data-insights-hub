...
const AreaChart = () => {
  ...
  const { settings, getColorScheme, getLineChartColors, formatNumber, getAnimationDuration } = useSettings();

  // Sample data for demonstration
  const areaColors = getLineChartColors(3);
  const sampleData = {
    labels: [
      'Q1 2023',
      'Q2 2023',
    ...
    datasets: [
      {
        label: 'Revenue',
        data: [120000, 150000, 180000, 200000, 220000, 250000, 280000, 300000],
        ...areaColors[0],
        backgroundColor: areaColors[0].backgroundColor.replace('0.1)', '0.2)'),
        fill: true,
        tension: 0.4,
      },
      {
        ...
        ...areaColors[1],
        backgroundColor: areaColors[1].backgroundColor.replace('0.1)', '0.2)'),
        fill: true,
        tension: 0.4,
      },
      {
        label: 'Profit',
        data: [40000, 60000, 80000, 90000, 100000, 120000, 140000, 150000],
        ...areaColors[2],
        backgroundColor: areaColors[2].backgroundColor.replace('0.1)', '0.2)'),
        fill: true,
        tension: 0.4,
      },
    ],
  ...
  const processDataWithColors = (rawData) => {
    ...
    const areaColors = getLineChartColors(datasetCount);
    ...
    return {
      ...
      datasets: rawData.datasets.map((dataset, index) => ({
        ...dataset,
        ...areaColors[index],
        backgroundColor: areaColors[index].backgroundColor.replace('0.1)', '0.2)'),
  ...
  const downloadSampleData = () => {
    ...
    link.href = url;
    link.download = 'area-chart-sample-data.json';
    link.click();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Display cumulative data and trends with filled area charts for
        ...
        <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
          ...
          <pre className="text-sm text-blue-800 dark:text-blue-200 overflow-x-auto">
            {`{
  "labels": ["Q1 2023", "Q2 2023", "Q3 2023"],
  "datasets": [
    {
      "label": "Revenue",
