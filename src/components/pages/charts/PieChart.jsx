...
const PieChart = () => {
    ...
    datasets: [
      {
        ...
        borderColor: getColorScheme(4).map(color => color.replace('0.8', '1')),
        borderWidth: 2,
      },
    ],
  };
  ...
  const downloadSampleData = () => {
    ...
    link.href = url;
    link.download = 'pie-chart-sample-data.json';
    link.click();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Display proportional data and percentages with interactive pie
            charts.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <div className="h-96" ref={chartRef}>
            {data ? (
              <Pie data={data} options={options} key={`${settings.colorScheme}-${settings.animationSpeed}-${settings.showLegend}`} />
            ) : (
