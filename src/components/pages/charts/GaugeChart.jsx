...
const GaugeChart = () => {
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          getColorScheme(1)[0].replace('1)', '0.8)'),
          isDark ? 'rgba(75, 85, 99, 0.3)' : 'rgba(229, 231, 235, 0.3)',
        ],
        borderColor: [getColorScheme(1)[0], isDark ? 'rgb(75, 85, 99)' : 'rgb(229, 231, 235)'],
        borderWidth: 0,
        cutout: '70%',
      },
    ],
      ...
      tooltip: {
        ...
        callbacks: {
          label: function (context) {
            return `Performance: ${formatNumber(context.parsed)}%`;
          },
        },
      },
    },
  ...
  const downloadSampleData = () => {
    ...
    link.href = url;
    link.download = 'gauge-chart-sample-data.json';
    link.click();
  ...
  const percentage = data ? data.datasets[0].data[0] : 0;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Display progress, performance metrics, or completion rates with
            gauge charts.
          </p>
        </div>
          ...
          <div className="h-96 flex items-center justify-center" ref={chartRef}>
            {data ? (
              <div className="relative w-80 h-80">
                <Doughnut 
                  key={`${settings.colorScheme}-${settings.animationSpeed}-${settings.showLegend}-${isDark}`}
                  data={data} 
                  options={options} 
                />
  ...
  "datasets": [
    {
      ...
      "cutout": "70%"
          ...
          <p className="text-sm text-blue-700 dark:text-blue-300 mt-2">
            Note: The first value in the data array represents the percentage
            (0-100), and the second value is the remaining percentage (100 -
            first value).
          </p>
        </div>
      </div>
